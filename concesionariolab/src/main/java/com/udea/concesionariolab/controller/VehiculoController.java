...
import com.udea.concesionariolab.ejb.VehiculoFacade;
...
public class VehiculoController implements Serializable {
    ...
    @EJB
    private com.udea.concesionariolab.ejb.VehiculoFacade ejbFacade;
...
public void handleFileUpload(FileUploadEvent event) {
    ...
    if (file != null) {
        // Asignar el contenido del archivo a la propiedad foto de current (Vehículo actual)
        current.setFoto(file.getContents()); // Usar getContents() en PrimeFaces 5
        System.out.println("Imagen cargada con éxito: " + file.getFileName());
    } else {
